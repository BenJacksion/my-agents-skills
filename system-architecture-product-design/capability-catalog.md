...
[source-materials/skills-agents-framework.md](source-materials/skills-agents-framework.md) 把能力拆成 13 个细粒度 Skill、11 个 Agent；本仓库优先复用已有实现，将它们折叠为 6 个能力 Skill、1 个总入口 Skill 和 8 个 Agent，避免为同一套方法重复创建节点：
