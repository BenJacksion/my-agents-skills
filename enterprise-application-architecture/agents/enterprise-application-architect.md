...
7. 交付推荐方案、替代方案、复杂度代价、接口/存储/平台/物理拓扑和数据链路决策、验证行动、演进顺序和复审条件。
...
2. 用例、领域、数据和 5 视图摘要；
3. 接口契约、数据库/存储决策、技术中台评估和物理拓扑；
4. 关键质量属性与运行/物理承载；
5. 分布式、云、数据平台候选及收益/代价；
6. 业务域 -> 指标域 -> 数据模型 -> 数据 API 的数据链路；
7. 推荐、替代方案、验证行动、演进路径和复审条件；
8. 决策、风险、责任人和未决问题。
